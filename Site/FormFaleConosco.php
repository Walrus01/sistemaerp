...
<body class="bg-secondary bg-gradient text-white">
    ...
    <form action="../Adm/ControleFaleConosco.php" method="POST" name="FormFaleConosco" id="FormFaleConosco">
        <div class="container mt-5 mb-5 d-flex justify-content-center">
            <div class="color-secondary card px-4 py-4 border border-light p-2 rounded-3" data-bs-theme="dark">
                <div class="card-body">
                    <h4 class="color-tertiary card-title mb-3">Fale Conosco</h4>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="color-primary form-control border border-light p-2" type="text" name="NomeCliente" id="NomeCliente" placeholder="Nome" maxlength="100" size="60" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <div class="input-group">
                                    <select class="form-select color-primary mt-2 p-2 border border-light" name="AssuntoFC" id="AssuntoFC" aria-label="Default select example">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <textarea class="form-control color-primary" id="exampleFormControlTextarea1" name="DescFC" id="DescFC" rows="6" placeholder="Descreva aqui!" maxlength="300"></textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group mt-4">
                                <div class="input-group justify-content-center">
                                    <button class="btn btn-outline-light" type="submit" name="Enviar">Enviar</button>
